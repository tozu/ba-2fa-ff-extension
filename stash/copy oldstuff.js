let { Cc, Ci, Cu, Cr } = require("../chrome"); //  declaration to access chrom authority
                                          // Cc - alias for Components.classes
                                          // Ci - alias for Components.interfaces
                                          // Cu - alias for Components.utils

var GETRequest = Cc["@mozilla.org/xmlextras/xmlhttprequest;1"].createInstance(Ci.nsIXMLHttpRequest);
...
function makeRequest() {
  ...
  if(GETRequest) {
    ...
    GETRequest.addEventListener("loadend", loaded(e));
